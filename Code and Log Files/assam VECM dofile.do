clear
log using "Assam Log.txt", replace
//use "/Users/shraddhaanand/Documents/Classes/Spring 2020/MIT 14.33/Homework/Data/all_cleaned_labeled.dta" if s == "AP"
use "/Users/shraddhaanand/Documents/Classes/Spring 2020/MIT 14.33/Homework/Data/States Data/assam_finalData.dta"
...
graph twoway tsline logpublic logprivate logsdp, title("Private investment, Public investment and SDP: Assam")
...
vec logprivate logpublic logsdp, trend(trend) lags(4)

irf create var1, step(20) set(myirf) replace
irf graph oirf, impulse(logpublic logprivate) response(logpublic logprivate) yline(0,lcolor(black)) xlabel(0(4)20) byopts(yrescale)
