clear
log using "Chandigarh Log.txt", replace
//use "/Users/shraddhaanand/Documents/Classes/Spring 2020/MIT 14.33/Homework/Data/all_cleaned_labeled.dta" if s == "AP"
use "/Users/shraddhaanand/Documents/Classes/Spring 2020/MIT 14.33/Homework/Data/States Data/chand_finalData.dta"
...
graph twoway tsline logpublic logprivate logsdp, title("Private investment, Public investment, and SDP: Chandigarh")
...
irf graph oirf, impulse(logpublic) response(logpublic logprivate) yline(0,lcolor(black)) xlabel(0(4)20) byopts(yrescale)
