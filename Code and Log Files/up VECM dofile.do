clear
log using "UttarPradesh Log.txt", replace
//use "/Users/shraddhaanand/Documents/Classes/Spring 2020/MIT 14.33/Homework/Data/all_cleaned_labeled.dta" if s == "AP"
use "/Users/shraddhaanand/Documents/Classes/Spring 2020/MIT 14.33/Homework/Data/States Data/up_finalData.dta"
...
graph twoway tsline logpublic logprivate logsdp, title("Private investment, Public investment, and SDP: Uttar Pradesh")
...
vecrank logprivate logpublic logsdp, trend(constant) lags(4)
//rank = 1 --> I(1) series so need to do VAR

vec logprivate logpublic logsdp, trend(constant) lags(4)
