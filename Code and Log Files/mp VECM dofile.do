clear
log using "MadhyaPradesh Log.txt", replace
//use "/Users/shraddhaanand/Documents/Classes/Spring 2020/MIT 14.33/Homework/Data/all_cleaned_labeled.dta" if s == "AP"
use "/Users/shraddhaanand/Documents/Classes/Spring 2020/MIT 14.33/Homework/Data/States Data/mp_finalData.dta"
...
graph twoway tsline logpublic logprivate logsdp, title("Private investment, Public investment, and SDP: Madhya Pradesh")
...
vecrank logprivate logpublic logsdp, trend(none) lags(2)
//rank = 1 --> I(1) series so need to do VAR

vec logprivate logpublic logsdp, trend(trend) lags(2)
